  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.viewtop1}>
        <Ips Text="Name" placeholder="Họ và tên" onChangeText={setname} />
      </View>
      <View style={styles.viewtop1}>
        <Ips Text="Phone" placeholder="Số điện thoại" onChangeText={setphone} />
      </View>
      <View style={styles.viewtop1}>
        <Ips Text="Email" placeholder="Email" onChangeText={setemail} />
      </View>
      <View style={styles.viewtop1}>
        <Ipspass
          Text="Password"
      ...
      <Btns color="#81d3e3" Text="Đăng kí" onPress={onSignUp}></Btns>
    </View>
  );
}
